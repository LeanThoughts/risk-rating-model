...
public class Initializer implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        if (modelCategoryRepository.findByCode(1) == null) {
            ModelCategory c1 = new ModelCategory(1, "Renewable-Build");
            modelCategoryRepository.save(c1);
        }

        if (modelCategoryRepository.findByCode(2) == null) {
            ModelCategory c2 = new ModelCategory(2, "Renewable-Operational");
            modelCategoryRepository.save(c2);
        }

        if (modelCategoryRepository.findByCode(3) == null) {
            ModelCategory c3 = new ModelCategory(3, "InfraTransmission-Build");
            modelCategoryRepository.save(c3);
        }
        if (modelCategoryRepository.findByCode(4) == null) {
            ModelCategory c4 = new ModelCategory(4, "InfraTransmission-Operational");
            modelCategoryRepository.save(c4);
        }
        if (modelCategoryRepository.findByCode(4) == null) {

            ModelCategory c5 = new ModelCategory(5, "InfraRoadProjectHybridAnnuity-Build");
            modelCategoryRepository.save(c5);
        }
        if (modelCategoryRepository.findByCode(6) == null) {

            ModelCategory c6 = new ModelCategory(6, "InfraRoadProjectHybridAnnuity-Operational");
            modelCategoryRepository.save(c6);
        }
        if (modelCategoryRepository.findByCode(7) == null) {

            ModelCategory c7 = new ModelCategory(7, "InfraRoadProjectToll-Build");
            modelCategoryRepository.save(c7);
        }
        if (modelCategoryRepository.findByCode(8) == null) {
            ModelCategory c8 = new ModelCategory(8, "InfraRoadProjectToll-Operational");
            modelCategoryRepository.save(c8);
        }
        if (modelCategoryRepository.findByCode(9) == null) {

            ModelCategory c9 = new ModelCategory(9, "HoldingCompany-Build");
            modelCategoryRepository.save(c9);
        }
        if (modelCategoryRepository.findByCode(10) == null) {
            ModelCategory c10 = new ModelCategory(10, "HoldingCompany-Operational");
            modelCategoryRepository.save(c10);
        }
        if (modelCategoryRepository.findByCode(11) == null) {

            ModelCategory c11 = new ModelCategory(11, "SME & FI");
            modelCategoryRepository.save(c11);
        }
