...
import com.pfs.riskmodel.businessconfig.SME_FI_BuildPhaseGrade;
 ...
 */
public class SME_FI_BuildPhase_Valuator {



    List<ProjectGrade> projectGradeList = SME_FI_BuildPhaseGrade.projectGradeList;
...
//        // Project Scores and Grade
        ...
        //For SME & FI, There is only Project Implementation Risk
        // Build Phase Phase Score = Minimum of Project Impl Score and Post Project Impl Score
        projectScore = Math.min(projectImplScore, projectImplScore);
